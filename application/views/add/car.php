...
<input type="text" name="gosNum" value="<?php echo set_value('gosNum'); ?>" placeholder = "Введите гос. номер машины"/>
...
<?PHP echo form_dropdown('typeCar', $AllCar, set_value('typeCar')); ?>
